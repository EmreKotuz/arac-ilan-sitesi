...
//araba ekleme 
   if (@$_POST["submit"]) {
     ...
     $anahtarKelime = htmlspecialchars($_POST["anahtarKelime"], ENT_QUOTES, 'UTF-8');
            ...
            $yeni_ad="denemeresim/".$uret[rand(0,4)].$sayi_tut.$uzanti;

            if (move_uploaded_file($_FILES["resim"]["tmp_name"],$yeni_ad)){
                echo 'Dosya başarıyla yüklendi.';

     $ekle = $db->prepare("insert into blog(baslik,alt_baslik,aciklama,aktif,sehir,ilce,resim,anahtarKelime)values(:baslik,:alt_baslik,:aciklama,:aktif,:sehir,:ilce,:resim,:anahtarKelime)");
     $ekle->bindValue(":baslik",$baslik,PDO::PARAM_STR);
     $ekle->bindValue(":alt_baslik",$altbaslik,PDO::PARAM_STR);
     $ekle->bindValue(":aciklama",$aciklama,PDO::PARAM_STR);
     $ekle->bindValue(":aktif",$aktif,PDO::PARAM_INT);
     $ekle->bindValue(":resim",$yeni_ad,PDO::PARAM_STR);
     $ekle->bindValue(":anahtarKelime",$anahtarKelime,PDO::PARAM_STR);
     $ekle->bindValue(":sehir",$sehir,PDO::PARAM_STR);
     $ekle->bindValue(":ilce",$ilce,PDO::PARAM_STR);

   }
   else{
    header("Location: hata.html?i=uyari");
   }
  ...
  $("#Iller").change(function () {
    ...
    <div id="wrapper">
        ...
        <div style="margin-left:10%;margin-right:10%;">
            <div >
                <div class="col-lg-12">
                <h1 class="page-header">Yeni <i style="color: #27ae60;">(İlan)</i> ekle</h1>
                </div>
            </div>
            <div >
                <div class="col-lg-14">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                     <input type="file" name="resim"/><br>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="anahtarKelime" placeholder="Anahtar kelimeliri giriniz">
                                        </div>
                                        <div class="form-group">
                                            <label>İsimi</label>
                                            <input class="form-control" name="baslik" placeholder="İsmini Giriniz">
                                        </div>
                                        <div class="form-group">
                                            <label>Telefon Numarası</label>
                                            <input class="form-control" name="altbaslik" placeholder="545..">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <select name="ilce" id="Ilceler" disabled="disabled">
                                        ...
                                        <input type="submit" name="submit" style="width:20%;"value="Kaydet" class="btn btn-success">
